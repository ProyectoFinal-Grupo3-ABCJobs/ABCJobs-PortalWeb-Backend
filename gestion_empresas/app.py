...
api.add_resource(VistaMotorEmparPorIdFicha,'/company/motorEmparejamiento/ficha/<int:id_ficha>')
api.add_resource(VistaResultadoEmparejamientoPorIdFicha,'/company/motorEmparejamiento/ficha/<int:id_ficha>')
